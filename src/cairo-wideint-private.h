...
cairo_uint64_t I	_cairo_uint32_to_uint64 (xuint32_t i);
...
cairo_uint64_t I	_cairo_uint32x32_64_mul (xuint32_t a, xuint32_t b);
...
#define			_cairo_uint64_negative(a)   (((xint32_t) ((a).hi)) < 0)
cairo_uint64_t I	_cairo_uint64_not (cairo_uint64_t a);

#define			_cairo_uint64_to_int64(i)   (i)
#define			_cairo_int64_to_uint64(i)   (i)

cairo_int64_t  I	_cairo_int32_to_int64(xint32_t i);
#define			_cairo_int64_to_int32(a)    ((xint32_t) _cairo_uint64_to_uint32(a))
#define			_cairo_int64_add(a,b)	    _cairo_uint64_add (a,b)
#define			_cairo_int64_sub(a,b)	    _cairo_uint64_sub (a,b)
#define			_cairo_int64_mul(a,b)	    _cairo_uint64_mul (a,b)
cairo_int64_t  I	_cairo_int32x32_64_mul (xint32_t a, xint32_t b);
...
#define			_cairo_int64_negative(a)    (((xint32_t) ((a).hi)) < 0)
...
#define			_cairo_uint32_to_uint64(i)  ((xuint64_t) (i))
#define			_cairo_uint64_to_uint32(i)  ((xuint32_t) (i))
#define			_cairo_uint64_add(a,b)	    ((a) + (b))
#define			_cairo_uint64_sub(a,b)	    ((a) - (b))
#define			_cairo_uint64_mul(a,b)	    ((a) * (b))
#define			_cairo_uint32x32_64_mul(a,b)	((xuint64_t) (a) * (b))
#define			_cairo_uint64_lsl(a,b)	    ((a) << (b))
#define			_cairo_uint64_rsl(a,b)	    ((xuint64_t) (a) >> (b))
#define			_cairo_uint64_rsa(a,b)	    ((xuint64_t) ((xint64_t) (a) >> (b)))
#define			_cairo_uint64_lt(a,b)	    ((a) < (b))
#define                 _cairo_uint64_cmp(a,b)       ((a) == (b) ? 0 : (a) < (b) ? -1 : 1)
#define			_cairo_uint64_is_zero(a)    ((a) == 0)
#define			_cairo_uint64_eq(a,b)	    ((a) == (b))
#define			_cairo_uint64_negate(a)	    ((xuint64_t) -((xint64_t) (a)))
#define			_cairo_uint64_negative(a)   ((xint64_t) (a) < 0)
#define			_cairo_uint64_not(a)	    (~(a))

#define			_cairo_uint64_to_int64(i)   ((xint64_t) (i))
#define			_cairo_int64_to_uint64(i)   ((xuint64_t) (i))

#define			_cairo_int32_to_int64(i)    ((xint64_t) (i))
#define			_cairo_int64_to_int32(i)    ((xint32_t) (i))
#define			_cairo_int64_add(a,b)	    ((a) + (b))
#define			_cairo_int64_sub(a,b)	    ((a) - (b))
#define			_cairo_int64_mul(a,b)	    ((a) * (b))
#define			_cairo_int32x32_64_mul(a,b) ((xint64_t) (a) * (b))
#define			_cairo_int64_lt(a,b)	    ((a) < (b))
#define                 _cairo_int64_cmp(a,b)       ((a) == (b) ? 0 : (a) < (b) ? -1 : 1)
#define			_cairo_int64_is_zero(a)     ((a) == 0)
#define			_cairo_int64_eq(a,b)	    ((a) == (b))
#define			_cairo_int64_lsl(a,b)	    ((a) << (b))
#define			_cairo_int64_rsl(a,b)	    ((xint64_t) ((xuint64_t) (a) >> (b)))
#define			_cairo_int64_rsa(a,b)	    ((xint64_t) (a) >> (b))
...
static inline xint32_t
_cairo_int64_32_div (cairo_int64_t num, xint32_t den)
{
#if !HAVE_UINT64_T
...
cairo_uint128_t I	_cairo_uint32_to_uint128 (xuint32_t i);
...
cairo_int128_t  I	_cairo_int32_to_int128 (xint32_t i);
...
#define			_cairo_uint128_to_uint64(i) ((xuint64_t) (i))
#define			_cairo_uint128_to_uint32(i) ((xuint32_t) (i))
...
#define			_cairo_int128_to_int64(i)   ((xint64_t) (i))
#define			_cairo_int128_to_int32(i)   ((xint32_t) (i))
